...
namespace MyWpfCoreExcelImport.Tools
{
    public class ItemListToXml
    {
        ...
        public void Save(string selectedItemValues, ObservableCollection<string> oc)
        {
            try
            {
                XmlSerializer serializer = new XmlSerializer(typeof(ItemListToXml));
        ...
        public ObservableCollection<string> Load(ref string selectedItemValues)
        {
            try
            {
                ...
                {
                    var xmlImport = serializer.Deserialize(rd) as ItemListToXml;
        ...
        /// SetDefaultValues
        /// </summary>
        private void SetDefaultValues(ItemListToXml iltx)
        {
